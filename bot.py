...
SYSTEM_PROMPT = (
    ...
    "Если в системном сообщении указано что клиент постоянный — применяй скидку 10% к итоговой стоимости и сообщи об этом клиенту. "
    "Если клиент новый — скидки нет, не упоминай это клиенту никак. "
...
def clean_text(text):
    ...
    # Убираем слова с диакритикой (вьетнамский, французский и др.) — не кириллица и не ASCII
    result = re.sub(r'\b\w*[\u0080-\u024f\u1e00-\u1eff]\w*\b', '', result)
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        hallucination_markers = (
            ...
            "постоянный_клиент", "постоянный клиент=", "статус постоянный",
        )
